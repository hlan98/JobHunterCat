...
<p align="center">
  🇨🇳 <b>中文</b>（当前）· 🇬🇧 <a href="README_EN.md"><b>English</b></a>
</p>
...
| 翻到下一个职位前 | 2.5~6 秒为主，约 **6%** 概率出现 6~10 秒长停顿 |
...
> **语言说明**：本仓库另有英文版 [`README_EN.md`](README_EN.md)；如两版表述不一致，**以本中文版为准**。
> **Language**: an English version is available at [`README_EN.md`](README_EN.md); where the two differ, **the Chinese version governs**.
